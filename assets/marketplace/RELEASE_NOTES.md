...
- Detect and navigate newly observed unresolved Sentry issues.
- Open the selected issue and its best local source frame.
- Hand an issue to a configured local coding agent on demand.
